...
export const GameScene_3 = new Phaser.Class({
  Extends: Phaser.Scene,

  initialize() {
    Phaser.Scene.call(this, { key: "GameScene_3" });
  },
  ...
  create() {
    ...
    platforms.create(600, 400, "ice");
    platforms.create(50, 250, "ice");
    platforms.create(600, 100, "ice");


    //ovi renderöidään
    door = this.physics.add.staticGroup();
    door.create(700, 50, "friend");
